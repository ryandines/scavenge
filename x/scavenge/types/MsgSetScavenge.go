...
func NewMsgSetScavenge(creator sdk.AccAddress, id string, description string, solutionHash string, reward string, solution string, scavenger string) MsgSetScavenge {
